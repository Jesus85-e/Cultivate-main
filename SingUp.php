...
<body background="./img/singup.jpg">
  <nav class="navbar navbar-expand-lg navbar-light " style="background-color:  #fbfbe5 ;">
    ...
    <div class="col-md-4 mx-auto">
      <div class="card mt-4 text-center border-success"  >
        <div class="card-header" style="background-color:  #f3a50d ;"></div>
        <div class="card-body " style="background-color:  #fbfbe5 ;">
          ...
          <form>
            <div class="form-group" >
              <input type="email" class="form-control email-input" id="email" placeholder="Email" autofocus >
            </div>
            <div class="form-group">
              <input type="password" class="form-control pas-input" id="password" placeholder="Password">
            </div>
            <div class="form-group">
              <label for="roles" class="">Tipo de Usuario:</label>
              <br>
              <select name="roles" id="roles" class="form-control">
                <option value="0">Seleccione..</option>
                <option value="2">Aprendis</option>
                <option value="3">Vendedor</option>
              </select>
            </div>
            <a type="submit" class="user-submit btn btn-success" href="">Registrarse</a>
            <br></br>
            <a href="/index.html">Regresar <i class="fa fa-arrow-left" aria-hidden="true"></i></a>
          </form>
        </div>
