...
<body background="./img/fondo.jpg!d" class="body">
    ...
    <center>
    <div>
        <h1>BIENVENIDOS A CULTIVATE</h1>
    </div>
    </center>
    <div class="container">
    Misión
La misión de cultiv@te es brindar información de calidad a los usuarios para que estos se puedan capacitar y poder implementarlo en sus hogares permitir que puedan emprender o cultiva sus propios alimentos.
    </div>
